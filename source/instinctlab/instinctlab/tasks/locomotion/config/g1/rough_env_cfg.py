"""Explicit G1 selections for the rough-ground locomotion task."""
...
class G1LocomotionRoughPolicyObsCfg(LocomotionPolicyObsCfg):
...
class G1LocomotionRoughCriticObsCfg(LocomotionCriticObsCfg):
    def __init__(self, robot: RobotSpec) -> None:
        super().__init__()
        self.joint_pos = ObsTermSpec(
            func=observations.joint_pos_rel,
...
class G1LocomotionRoughRewardsCfg(LocomotionRewardsCfg):
...
class G1LocomotionRoughEnvCfg(LocomotionEnvCfg):
    def __init__(self, robot: RobotSpec) -> None:
        super().__init__()
        self.robot = robot
        ...
        policy = G1LocomotionRoughPolicyObsCfg(robot)
        critic = G1LocomotionRoughCriticObsCfg(robot)
        self.observations = {
            "policy": ObsGroupSpec(
        ...
        locomotion_rewards = G1LocomotionRoughRewardsCfg()
        self.rewards = {
            "rewards": {
                ...
                "joint_deviation_arms": locomotion_rewards.joint_deviation_arms,
