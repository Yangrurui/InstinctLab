"""Explicit G1 selections for the flat locomotion task."""
...
class G1LocomotionFlatPolicyObsCfg(LocomotionPolicyObsCfg):
...
class G1LocomotionFlatCriticObsCfg(LocomotionCriticObsCfg):
    def __init__(self, robot: RobotSpec) -> None:
        super().__init__()
        self.joint_pos = ObsTermSpec(
            func=observations.joint_pos_rel,
...
class G1LocomotionFlatRewardsCfg(LocomotionRewardsCfg):
...
class G1LocomotionFlatEnvCfg(LocomotionEnvCfg):
    def __init__(self, robot: RobotSpec) -> None:
        ...
        policy = G1LocomotionFlatPolicyObsCfg(robot)
        critic = G1LocomotionFlatCriticObsCfg(robot)
        self.observations = {
            "policy": ObsGroupSpec(
        ...
        locomotion_rewards = G1LocomotionFlatRewardsCfg()
        self.rewards = {
            "rewards": {
