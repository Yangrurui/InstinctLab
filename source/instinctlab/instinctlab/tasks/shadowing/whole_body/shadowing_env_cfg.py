...
def _policy_proprioception(joints: EntityRef) -> dict[str, ObsTermSpec]:
    return {
...
def _critic_proprioception(joints: EntityRef) -> dict[str, ObsTermSpec]:
    return {
...
def make_observations(
    robot: RobotSpec, motion_reference: MotionReferenceRef
    ...
    policy_terms.update(_policy_proprioception(joints))
    ...
    critic_terms.update(_critic_proprioception(joints))
    return {
        "policy": ObsGroupSpec(
            terms=policy_terms,
