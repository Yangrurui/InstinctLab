...
def track_lin_vel_xy_exp(
    ...
    is large. Matched-rollout diagnostics score both frames on the same rollout so policy quality
    cancels. The two velocities differ by 0.067 m/s on average (the lever is 0.185 m, not
