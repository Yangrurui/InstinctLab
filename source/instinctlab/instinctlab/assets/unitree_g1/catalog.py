"""Engine-neutral Unitree G1 robot catalog.

This module owns canonical names, robot parameters, and backend asset references. It imports no
simulator SDK; native articulation construction belongs to the corresponding engine package.
"""
