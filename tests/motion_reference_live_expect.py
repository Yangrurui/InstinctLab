...
def motion_only_parkour_task(engine: str) -> Any:
...
def assert_motion_clock_and_exhaustion(env: Any, task: Any, *, device: str) -> None:
    ...
    from instinctlab.tasks.parkour.mdp.terminations import dataset_exhausted
