...
def test_shadowing_motion_effective_contract_matches_both_references() -> None:
    ...
    for task_id in task_ids:
        motion = _task(task_id).scene.motion_references[0]
        ...
        exhausted = _task(task_id).mdp.terminations["dataset_exhausted"]
...
def test_play_and_one_motion_apply_the_reference_sampling_overrides() -> None:
    whole_play = _task("Instinct-Shadowing-WholeBody-Plane-G1-Play-v0").scene.motion_references[0]
    perceptive_play = _task("Instinct-Perceptive-Shadowing-G1-Play-v0").scene.motion_references[0]
    one_motion = _task("Instinct-Perceptive-Shadowing-G1-OneMotion-v0").scene.motion_references[0]
