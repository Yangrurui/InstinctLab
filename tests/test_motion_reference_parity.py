...
_PARKOUR_REFERENCE = parkour_target_g1(
    paired_robot_spec(PARKOUR_ASSET_ID)
).scene.motion_reference("motion_reference")
PARKOUR_MOTION_CLIP = _PARKOUR_REFERENCE.clip
PARKOUR_MOTION_LINKS = _PARKOUR_REFERENCE.links
...
def packed():
    ...
    robot = paired_robot_spec(PARKOUR_ASSET_ID)
