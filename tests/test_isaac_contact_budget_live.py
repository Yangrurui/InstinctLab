...
def test_guard_fires_on_real_physx_collision_stack_overflow() -> None:
    ...
    from instinctlab.utils.contact_overflow import ContactOverflowError, check_contact_overflow, contact_budget_snapshot

    compiled = IsaacSimAdapter().compile(parkour_target_g1(), num_envs=16, device=device)
